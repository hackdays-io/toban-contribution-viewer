...
Revision ID: 23372f1dd158
Revises: 
Create Date: 2025-04-16 02:11:54.380042
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_integrationcredential_id"),
        "integrationcredential",
        ["id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column("is_bot_member", sa.Boolean(), nullable=False),
