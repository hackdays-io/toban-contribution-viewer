...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "is_connected", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
        sa.Column(
            "connection_status",
            sa.String(50),
    ...
    op.create_index(
        "ix_slackworkspace_slack_id", "slackworkspace", ["slack_id"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "is_supported", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
        sa.Column("last_sync_at", sa.DateTime(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "reaction_count", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
    ...
    op.create_index(
        "ix_slackmessage_message_datetime", "slackmessage", ["message_datetime"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_slackmessage_user_id_slack_ts", "slackmessage", ["user_id", "slack_ts"]
    )
