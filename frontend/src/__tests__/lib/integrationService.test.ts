...
describe('Integration API Service', () => {
  ...
  describe('getIntegrations', () => {
    ...
    it('should include service type when specified', async () => {
      ...
      // Start the request
      const resultPromise = integrationService.getIntegrations(
        mockTeamId,
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        expect.stringContaining(
          `team_id=${mockTeamId}&service_type=${IntegrationType.SLACK}`
        ),
        expect.any(Object)
      )
  ...
  describe('getResources', () => {
    ...
    it('should include resource type filters when specified', async () => {
      ...
      await integrationService.getResources(mockIntegrationId, [
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        expect.stringContaining(
          'resource_type=slack_channel&resource_type=slack_user'
        ),
        expect.any(Object)
      )
    })
  ...
  describe('revokeShare', () => {
    it('should revoke an integration share', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        expect.stringContaining(
          `/integrations/${mockIntegrationId}/share/${targetTeamId}`
        ),
        expect.objectContaining({
          method: 'DELETE',
        })
  ...
  describe('grantResourceAccess', () => {
    it('should grant access to a resource', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        expect.stringContaining(
          `/integrations/${mockIntegrationId}/resources/${mockResourceId}/access`
        ),
        expect.objectContaining({
          method: 'POST',
