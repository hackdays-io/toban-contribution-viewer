  ...
  return (
    <Box p={6} maxW="1200px" mx="auto">
      ...
      <SlackUserCacheProvider workspaceId={demoWorkspaceId}>
        ...
        <Card mb={8}>
          ...
          <CardBody>
            <Grid templateColumns="repeat(4, 1fr)" gap={6}>
              ...
              <GridItem>
                <Text fontWeight="bold" mb={2}>Fetch From Slack API</Text>
                <SlackUserDisplay 
                  userId="non-existent-id" 
                  workspaceId={demoWorkspaceId}
                  showAvatar={true}
        ...
        <Card mb={8} borderColor="green.300" borderWidth={1}>
          <CardHeader bg="green.50">
            <Heading size="md" color="green.700">New Feature: Fetch From Slack API</Heading>
          </CardHeader>
          <CardBody>
            <Text mb={4}>
              The <Code>fetchFromSlack</Code> option enables the component to retrieve user data directly 
              from the Slack API when a user is not found in the database. This feature is particularly 
              useful in the following scenarios:
            </Text>
            
            <Box pl={4} mb={4}>
              <Text>• When displaying messages from users who joined recently</Text>
              <Text>• During initial data loading before a full sync</Text>
              <Text>• When handling messages from users in private channels you haven't synced</Text>
              <Text>• To reduce the need for manual data synchronization</Text>
            </Box>
            
            <Text fontWeight="bold">Example Usage:</Text>
...
/>`}
            ...
            <Text mt={4} fontSize="sm" color="gray.600">
              Note: When enabled, this option may result in additional API calls to Slack, which could 
              impact performance or API rate limits if used extensively. The data fetched from Slack 
              is automatically cached in the database for future use.
            </Text>
          </CardBody>
        </Card>
