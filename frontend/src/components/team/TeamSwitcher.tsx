        ...
        <MenuList>
          {teamContext.teams.map(team => (
            <MenuItem 
              ...
              fontWeight={team.id === teamContext.currentTeamId ? 'bold' : 'normal'}
            >
              {team.name}
            </MenuItem>
          ))}
  ...
  return (
    <Menu>
      ...
      >
        <HStack>
          {currentTeam && (
            <Avatar size="xs" name={currentTeam.name} />
          )}
            ...
            >
              <Flex alignItems="center" width="100%">
                <HStack flex="1">
                  ...
                  <Box>
                    <Text fontWeight={team.id === teamContext.currentTeamId ? 'bold' : 'normal'}>
                      {team.name}
                    </Text>
                  </Box>
                </HStack>
